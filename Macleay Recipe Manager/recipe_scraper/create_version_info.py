...
"""
    ...
    # Also keep _version.py in sync so the app displays the right version
    with open("_version.py", "w", encoding="utf-8") as f:
        f.write(f'# Auto-generated by create_version_info.py. Do not edit manually.\n__version__ = "{short_ver}"\n')
    print(f"Version string -> _version.py  (version {short_ver})")
